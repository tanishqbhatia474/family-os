...
export default function About() {
  return (
    <div className="relative min-h-screen">
      ...
      <section className="relative z-10 px-6 pt-20 pb-15 md:pt-32">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h1 className="text-[clamp(2.5rem,7vw,4.5rem)] leading-[0.95] font-bold tracking-[-0.03em] text-[var(--text)] mb-8">
              A place made
              <br />
              for <span className="text-[var(--accent)]">families</span>
            </h1>

            <p className="text-[clamp(1.125rem,2vw,1.375rem)] leading-relaxed text-[var(--muted)] max-w-2xl">
              This exists to help families make sense of their
              relationships, preserve what matters, and carry meaning forward —
              <span className="block mt-3 opacity-80">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-20 gap-y-24">
            ...
            >
              {/* Heading */}
              <motion.div variants={itemReveal} className="space-y-3">
                ...
                <motion.div
                  ...
                  className="h-px w-16 bg-[color-mix(in_srgb,var(--accent)_35%,transparent)] origin-left"
                />
              </motion.div>
              ...
              <div className="space-y-10">
                <motion.div variants={itemReveal} className="space-y-2">
                  <h3 className="text-[1.125rem] font-semibold text-[var(--text)]">
              ...
              <motion.p
                variants={itemReveal}
                className="text-base text-[var(--muted)] italic pt-4 border-t border-[var(--border)]"
              >
            ...
            <motion.div {...fadeUp} className="lg:col-span-5 lg:mt-20">
              <div className="sticky top-24 space-y-6">
                <div className="rounded-3xl border border-[var(--border)] bg-[color-mix(in_srgb,var(--panel)_85%,transparent)] p-8 fade-in-on-load">
                  <img
                ...
                <p className="text-sm text-[var(--muted)] max-w-[30ch] leading-relaxed">
          ...
          {/* What this is not */}
          <div className="mt-32 space-y-24 max-w-4xl">
            <motion.div {...fadeUp} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-[1.0625rem] leading-relaxed text-[var(--muted)] font-medium">
      ...
      {/* Privacy callout */}
      <section className="w-full px-6 md:px-10 lg:px-16 my-24">
        <div className="max-w-[1600px] mx-auto">
          <motion.div
            {...fadeUp}
            className="relative w-full rounded-3xl bg-gradient-to-br from-[color-mix(in_srgb,var(--accent)_8%,transparent)] to-transparent border-2 border-[var(--accent)] overflow-hidden"
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center p-12 md:p-16">
              <div className="space-y-6">
                <h3 className="text-[1.5rem] font-bold text-[var(--text)]">
              ...
              <div className="fade-in-on-load lg:pl-8">
                <img
                  src="/illustrations/core-values-dark.png"
                  alt=""
                  className="illustration light-only w-full max-w-sm mx-auto"
                />
                <img
                  src="/illustrations/core-values-light.png"
                  alt=""
                  className="illustration dark-only w-full max-w-sm mx-auto"
                />
              </div>
            </div>
          </motion.div>
