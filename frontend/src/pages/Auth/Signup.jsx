...
export default function Signup() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 py-8 sm:py-12">
      ...
      <div className="hidden sm:block absolute top-10 right-10 w-24 h-24 rounded-full bg-[var(--accent)] opacity-5 blur-3xl" />
      <div className="hidden sm:block absolute bottom-20 left-20 w-32 h-32 rounded-full bg-[var(--accent)] opacity-5 blur-3xl" />
      ...
      >
        ...
        >
          ...
          {error && (
            ...
            >
              <p className="text-xs sm:text-sm text-red-600 dark:text-red-400 text-center leading-relaxed">
                {error}
              </p>
            </motion.div>
          )}
